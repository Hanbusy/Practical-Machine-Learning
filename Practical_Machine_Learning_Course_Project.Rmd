...
dim(testing_raw)
```
### analyzing training dataset variables
...
```{r}
summary(training_raw[, c(6,8:10,12:14)])
```
...
### Creating and analyzing the prediction models: Decision Tree
...
### Creating and analyzing the prediction models: Random Forest
